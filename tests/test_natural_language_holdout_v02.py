...
V02_CORPUS = "evals/natural_language_rule_holdout_v0.2.json"


class V02OracleModel:
...
def test_v02_holdout_is_balanced_unique_and_validator_legal() -> None:
    cases = load_corpus(V02_CORPUS)
...
def test_v02_verified_oracle_scores_perfectly() -> None:
    cases = load_corpus(V02_CORPUS)
    model = V02OracleModel(cases)
